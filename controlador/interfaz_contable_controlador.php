...
//total actividades
    ...
    public function prueba(){
        ...
        $this->_phpexcel->getProperties()->setCreator("autor");
        $this->_phpexcel->getProperties()->setLastModifiedBy("autor");
        $this->_phpexcel->getProperties()->setTitle("titulo del Excel");
        $this->_phpexcel->getProperties()->setSubject("Asunto");
        $this->_phpexcel->getProperties()->setDescription("Descripcion");

...
<p><h3>Lista de Tipos de Movimiento</h3></p>
    <table border="1" class="tabgrilla">
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>tipo_movimiento/eliminar/<?php echo $this->datos[$i]['idtipo_movimiento'] ?>')">
    ...
    <?php } else { ?>
        <tr>
            <td><p>No hay tipos de movimiento</p></td>
        </tr>
    <?php } ?>
</table>

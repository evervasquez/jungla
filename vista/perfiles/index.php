...
<p><h3>Lista de Perfiles</h3></p>
    ...
    <table border="1" class="tabgrilla">
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>perfiles/editar/<?php echo $this->datos[$i]['idperfil'] ?>')">
                <img src="<?php echo BASE_URL?>lib/img/edit.png" class="imgfrm" /></a>
                <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>perfiles/eliminar/<?php echo $this->datos[$i]['idperfil'] ?>')">
    ...
    <?php } else { ?>
        <tr>
            <td><p>No hay perfiles</p>
        <a href="<?php echo BASE_URL?>perfiles/nuevo" class="k-button">Nuevo</a></td>
        </tr>
    <?php } ?>
</table>
    </div>
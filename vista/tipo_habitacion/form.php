<form method="post" action="<?php if(isset ($this->action))echo $this->action ?>">
    ...
    <table width="50%" align="center">
        ...
        <tr>
            ...
            <td><input type="text" class="k-textbox" placeholder="Ingrese tipo de habitacion" required name="descripcion"
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <a href="<?php echo BASE_URL ?>tipo_habitacion" class="k-button">Cancelar</a></p>
            </td>
        </tr>
    </table>
</form>
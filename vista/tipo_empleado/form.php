    ...
    <table width="50%" align="center" class="tabForm">
        ...
        <tr>
            ...
            <td><input type="text" class="k-textbox" readonly="readonly" name="codigo" id="codigo"
                       value="<?php if(isset ($this->datos[0]['idtipo_empleado']))echo $this->datos[0]['idtipo_empleado']?>"/></td>
        </tr>
        <tr>
            <td><label>Descripcion:</label></td>
            <td><input type="text" class="k-textbox" placeholder="Ingrese tipo" required name="descripcion" onkeypress="return soloLetras(event)"
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <a href="<?php echo BASE_URL ?>tipo_empleado" class="k-button">Cancelar</a></p>
            </td>
        </tr>
    </table>
</form>
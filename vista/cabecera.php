                ...
                <ul id="menu">
                    <li>Administracion
                        <ul>
                            ...
                            <li><a href="/sisjungla/vista/promociones/">Promociones</a></li>
                        </ul>
                    </li>
                    <li>Almacen
                        <ul>
                            <li><a href="/sisjungla/vista/productos/">Productos</a></li>
                            <li><a href="/sisjungla/vista/tipoproducto/">Tipo de Producto</a></li>
                            <li><a href="/sisjungla/vista/ubicacion/">Ubicacion</a></li>
                            <li><a href="/sisjungla/vista/almacen/">Almacen</a></li>
                            <li><a href="/sisjungla/vista/movimientoproducto/">Movimiento de Producto</a></li>
                            <li><a href="/sisjungla/vista/tipomovimiento/">Tipo Movimiento</a></li>
                        </ul>
                    </li>
                    <li>Compras
                        <ul>
                            <li><a href="/sisjungla/vista/compras/">Compras</a></li>
                            <li><a href="/sisjungla/vista/proveedores/">Proveedores</a></li>
                            <li><a href="/sisjungla/vista/cuotaspago/">Cuotas de Pago</a></li>
                            <li><a href="/sisjungla/vista/productos/">Productos</a></li>
                        </ul>
                    </li>
                    <li>Ventas
                        <ul>
                            ...
                            <li><a href="/sisjungla/vista/paquetes/">Paquetes</a></li>
                            <li><a href="/sisjungla/vista/cuotascobro/">Cuotas de cobros</a></li>
                        </ul>
                    </li>
                    <li>Estadia
                        <ul>

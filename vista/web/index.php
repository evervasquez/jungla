  <div class="border_box"><div id="photoIni">
			<div class="box_skitter box_skitter_large">
				<ul>
					<li><a href="#cube"><img src="<?php echo BASE_URL?>vista/web/photos/piscina.jpg" class="cube" /></a><div class="label_text"><p>Piscina</p></div></li>
					<li><a href="#cubeRandom"><img src="<?php echo BASE_URL?>vista/web/photos/restaurante.jpg" class="cubeRandom" /></a><div class="label_text"><p>Restaurante</p></div></li>
					<li><a href="#block"><img src="<?php echo BASE_URL?>vista/web/photos/recepcion.jpg" class="block" /></a><div class="label_text"><p>Recepcion</p></div></li>
					<li><a href="#cubeStop"><img src="<?php echo BASE_URL?>vista/web/photos/habitaciones.jpg" class="cubeStop" /></a><div class="label_text"><p>Habitaciones</p></div></li>
					<li><a href="#cubeHide"><img src="<?php echo BASE_URL?>vista/web/photos/eloje.jpg" class="cubeHide" /></a><div class="label_text"><p>Auditorium El Oje</p></div></li>
					<li><a href="#cubeSize"><img src="<?php echo BASE_URL?>vista/web/photos/areasverdes.jpg" class="cubeSize" /></a><div class="label_text"><p>Areas Verdes</p></div></li>
                    </ul>
			</div>
      </div>
  </div>

    <div id="servicios">
    	<div id="titServicios"><label>La Jungla ofrece los siguientes servicios</label></div>
        ...
        <div class="titcuServicios">Habitaciones</div>
        ...
        <div><img src="<?php echo BASE_URL ?>vista/web/photos/habitaciones.jpg" class="imgServicios" /></div>
        <div class="titcuServicios">Auditorium</div>
        ...
        <div><img src="<?php echo BASE_URL ?>vista/web/photos/eloje.jpg" class="imgServicios" /></div>
        <div class="titcuServicios">Restaurante</div>
        <div class="textServicios">RESTAURANTE CON COMIDA REGIONAL, NACIONAL Y ATENCIÓN PARA EVENTOS.</div>
        <div><img src="<?php echo BASE_URL ?>vista/web/photos/restaurante.jpg" class="imgServicios" /></div>
        <div class="titcuServicios">Piscina</div>
        <div class="textServicios">PISCINA CON  HIDROMASAJE, JACUZZI, ADEMÁS, CON PATERA PARA NIÑOS.</div>
        <div><img src="<?php echo BASE_URL ?>vista/web/photos/piscina.jpg" class="imgServicios" /></div>
    </div>
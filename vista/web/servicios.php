    <div id="servicios">
        ...
        <div>
            <img src="<?php echo BASE_URL ?>vista/web/photos/habitaciones.jpg" class="imgServicios" />
        </div>
        ...
        <div>
            <img src="<?php echo BASE_URL ?>vista/web/photos/eloje.jpg" class="imgServicios" />
        </div>
        ...
        <div>
            <img src="<?php echo BASE_URL ?>vista/web/photos/restaurante.jpg" class="imgServicios" />
        </div>
        ...
        <div>
            <img src="<?php echo BASE_URL ?>vista/web/photos/piscina.jpg" class="imgServicios" />
        </div>
    </div>